"""OpenAI (GPT + Ollama via base_url) provider adapter."""
...
def _build_messages(
    ...
    messages array — no separate system parameter needed.
    """
...
class OpenAIProvider:
    ...
    Covers OpenAI GPT models (api.openai.com), Ollama (via base_url),
    and any OpenAI-compatible API (LM Studio, vLLM, Azure, etc.).
    """
        ...
        *,
        ...
        if client is not None:
            ...
            if base_url is not None:
                ...
                # Local endpoints don't need a real API key
