...
- **Project structure**: `src/duh/` with cli/, consensus/, providers/, memory/, config/, core/, tools/
- **Testing**: pytest + pytest-asyncio + pytest-cov, 1093 tests, asyncio_mode=auto
...
- **Memory schema**: SQLAlchemy ORM — Thread, Turn, Contribution, TurnSummary, ThreadSummary, Decision, Outcome, Subtask, Vote
...
- **39 source files**, mypy strict clean, ruff clean
